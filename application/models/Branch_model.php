...
/*		$selected_columns = [
	...
	function getAllBatchs() {
		$query = $this->db->query("SELECT b.id, b.batch_name, b.branch_id, br.name as branch_name  FROM ".$this->db_table('batch_table')." as b JOIN ".$this->db_table('branch_table')." as br ON b.branch_id = br.id WHERE b.active = 1");
		return $query->result_array();
	}
