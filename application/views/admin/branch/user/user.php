                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="filter-section">
                                                                        ...
                                                                        <div class="col-md-12 col-lg-10">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-lg-2">
                                                                                    <div class="form-group row">
                                                                                        <div class="col-12">
                                                                                            <a class="btn btn-primary btn-custom waves-effect w-md waves-light m-b-5 user_search" style="color:#fff;width: 100%;">Search&nbsp;<i class="ti-search"></i></a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <input type="hidden" class="filter_action" value="user_filter">
                                                ...
                                                <div class="user_filter">
                                                    <?php $this->load->view('admin/branch/user/ajax/filter/list') ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php $this->load->view('admin/branch/user/add/user'); ?>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->            