                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <ul class="nav nav-tabs card-header-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" href="<?php echo base_url('admin/branch') ?>">Branch</a>
                                                    </li>
                                                    <li class="nav-item">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="filter-section">
                                                                        ...
                                                                        <div class="col-md-12 col-lg-10">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-lg-2">
                                                                                    <div class="form-group row">
                                                                                        <div class="col-12">
                                                                                            <input type="text" name="phone_mobile"  class="form-control" placeholder="Phone/mobile">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                 <div class="col-lg-2">
                                                                                ...
                                                                                <div class="col-lg-2">
                                                                                    <div class="form-group row">
                                                                                        <div class="col-12">
                                                                                            <a class="btn btn-primary btn-custom waves-effect w-md waves-light m-b-5 branch_search" style="color:#fff;width: 100%;">Search&nbsp;<i class="ti-search"></i></a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <input type="hidden" class="filter_action" value="branch_filter">
                                                            
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="branch_filter">
                                                    <?php $this->load->view('admin/branch/branch/ajax/filter/list') ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
