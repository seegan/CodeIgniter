    <h4 class="header-title m-t-0 text-center">New Instruction</h4>
    ...
    <div class="form-group row">
        ...
        <div class="col-7">
            <input type="text" required class="form-control" name="instruction_name" placeholder="Instruction Name" value="<?php echo set_value('instruction_name'); ?>">
        </div>
    </div>
