                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <ul class="nav nav-tabs card-header-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" href="<?php echo base_url('admin/exam') ?>">Exam</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="<?php echo base_url('admin/exam/scheduler') ?>">Schedule</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="card-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-4">
                                                                                    <div class="form-group row">
                                                                                        <div class="col-12">
                                                                                            <input type="text" name="exam_name"  class="form-control" placeholder="Search Question">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-lg-2">
